          ...
          <div key={signal.id} className="p-3 hover:bg-slate-800/30 transition-colors flex items-center justify-between group">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xs text-slate-500 uppercase tracking-tighter font-mono">{signal.type}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="px-2 py-0.5 rounded-full bg-slate-800 border border-slate-700 text-2xs text-slate-400 font-bold tracking-widest uppercase">
